...
function Sculptor(engineName, options) {
  ...
  // TODO: Remove test and command management from engine -- these should receive a list of tests and a commands object
  // This will allow for Sculptors to be isolated and make engines DRYer with command look ups
...
Sculptor.prototype = {
  ...
  'export': function (module) {
    ...
    // TODO: Get back to engine export -- it's more modular
    // return this.engine['export'](this.suite);
    return this.suite['export'](module);
  }
};
