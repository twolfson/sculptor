...
// TODO: Add jsmin-sourcemap to examples
...
function Sculptor(engineName, options) {
  ...
  // Save tests and generate command set for later
  this.tests = [];
  this.commands = new CommandSet(options);
}
Sculptor.prototype = {
...
// Add the testling engine
var testling = require('./engines/testling.engine.js');
addEngine('testling', testling);
