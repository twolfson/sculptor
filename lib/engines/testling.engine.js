...
function process(params) {
  ...
  // TODO: Plan of attack: [Iter 1] Generate test in plaintext, write out file contents, curl and upload file to run test
  // TODO: [Iter 2] Generate test, upload directly via node

  return require('fs').readFileSync(__dirname + '/../../testling_poc/example_test.js', 'utf8');
}
