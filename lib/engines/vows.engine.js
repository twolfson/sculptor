    ...
    traverse(batch).forEach(function traverseBatch (node) {
      ...
      if (key) {
        ...
        if (command) {
          ...
          // If the command is a string, attempt to replace it
          // TODO: We might want to formalize commands into a get/set class for infinite recursive lookups
